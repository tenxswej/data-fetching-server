...
| ---------- | -------- | ------------------ | ---------------------------------- |
| **Method** | **Body** | **Properties**     | **URL**                            |
| POST       | JSON     | username, password | http://localhost:3000/users/login/ |
...
| POST       | JSON     | token       | username, password | http://localhost:3000/users/logout/ |
...
| Schema         |           |          |         |                |
| -------------- | --------- | -------- | ------- | -------------- |
| **\_id**       | **title** | **body** | **tag** | **author**     |
| auto-generated | string    | string   | array   | auto-generated |
...
| ---------- | -------------------------------------------------------------------------- |
| **Method** | **URL**                                                                    |
| GET        | http://localhost:3000/posts/posts-filter?title=title&tag=tag&author=author |
...
| ---------- | -------- | ----------- | -------------- | ------------------------------------------- |
| **Method** | **Body** | **headers** | **Properties** | **URL**                                     |
| PUT        | JSON     | token       | body, tag      | http://localhost:3000/posts/edit-post-body/ |
...
| ---------- | -------- | ----------- | -------------- | ------------------------------------------ |
| **Method** | **Body** | **headers** | **Properties** | **URL**                                    |
| PUT        | JSON     | token       | tag            | http://localhost:3000/posts/edit-post-tag/ |
